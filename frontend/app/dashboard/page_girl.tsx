  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ 
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Small hearts and flowers scattered */}
        {[
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-8">
        ...
        {/* Navigation Bar - Soft Pastel Glass */}
        <motion.nav 
        ...
        {/* Hero Section - Pastel Dreamy Glass Panel */}
        <motion.div
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
            ...
            <div className="grid grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center items-center">
                ...
                >
                  ...
                  {/* Add soft glow behind illustration */}
            ...
            <div className="relative h-64">
              ...
              <svg className="w-full h-full pl-8" viewBox="0 0 900 250" preserveAspectRatio="none">
                <defs>
                  ...
                  <linearGradient id="lavenderGlow" x1="0%" y1="0%" x2="0%" y2="100%">
